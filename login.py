...
#        self.window.box(".",".")
        ...
        self.register_label=Label(self.subwin,3,10,3*int(self.sub_h/4),int(self.sub_w/5))
        self.register_label.setText(login_register)
        self.login_label=Label(self.subwin,3,10,3*int(self.sub_h/4),3*int(self.sub_w/5))
